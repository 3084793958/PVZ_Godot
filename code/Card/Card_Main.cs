...
{//未知意义的[Export],等我想通了再说
    ...
    public override void _Ready()
    {
        ...
        {
            Card_Background = 1;
            if (Card_Number[1] <= Public_Main.Plants_Zombies_list.Count)
            {
                if (Public_Main.Plants_Zombies_list[Card_Number[1] - 1].Item1 == Card_Number[1])
                {
                    Seed_Pos = Card_Number[1] - 1;
                }
                else
                {
                    ...
                    {
                        if (Public_Main.Plants_Zombies_list[i].Item1 == Card_Number[1])
                        {
                            Seed_Pos = i;
                            break;
                        }
        ...
        if (Card_enabled)
        {
            ...
            {
                Main_Card_Texture.Texture = Public_Main.Plants_Zombies_list[Seed_Pos].Item5;
                Name_Label.Text = Public_Main.Plants_Zombies_list[Seed_Pos].Item2;
