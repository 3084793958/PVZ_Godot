...
public class Small_Shroom_Bullets_Main : Normal_Plants_Bullets
{
    ...
    public override void _PhysicsProcess(float delta)
    {
        try
        {
            ...
            if (!has_touch || (on_Fire && touch_zombies_number < 3)) 
            {
    ...
    public void Touch_Zombies(Area2D area_node)
    {
        ...
        if ((!has_touch||on_Fire) && area_2D.Area2D_type == "Zombies")
        {
            ...
            if (Top_Zombies_Area.has_plant)
            {
                ...
                {
                    if (on_Fire && touch_zombies_number < 3)
                    { }
                    else
                    {
