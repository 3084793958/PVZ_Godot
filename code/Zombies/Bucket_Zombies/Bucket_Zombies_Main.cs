...
public class Bucket_Zombies_Main : Normal_Zombies
{
    ...
    private bool has_Lose_Hat = false;
    ...
    public override void _Process(float delta)
    {
        ...
        if (!has_planted)
        {
            if (Normal_Plants.Choosing)
            {
                ...
                {
                    dock_control.SetGlobalPosition(Area_Vector2 + new Vector2(10, -35));
                    on_lock_grid = true;
                }
                else
                {
                    dock_control.SetPosition(new Vector2(10, -35));
                    on_lock_grid = false;
                }
        ...
        else
        {
            ...
            else if (health < 545 && !GetNode<Cone_Hat_Control>("Main/Main/Hat").Hat_Run && !GetNode<AnimationPlayer>("Main/Main/Hat/Hat/Hat_Out").IsPlaying())
            {
