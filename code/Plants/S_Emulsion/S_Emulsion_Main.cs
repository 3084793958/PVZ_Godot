        ...
        if (!on_Shovel)
        {
            if (!has_change_N_H)
            {
                ...
                if (Dock_Area_2D != null)
                {
                    ...
                    {
                        if (Dock_Area_2D.N_OH < N_H && Dock_Area_2D.pH > 7.5f)
                        {
                ...
                {
                    if (Water_Area_List[i].N_OH < N_H && Water_Area_List[i].pH > 7.5f)
                    {
