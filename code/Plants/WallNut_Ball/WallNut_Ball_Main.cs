    ...
    public async void Area_Entered(Control_Area_2D area2D)
    {
        ...
        if (area2D.Area2D_type == "Zombies")
        {
            ...
            if (Zombies_Area_2D.has_plant)
            {
                ...
                {
                    if (Zombies_Area_2D.ZIndex > GetNode<Crash_Area_2D>("Main/Crash_Area").Crash_Area.ZIndex || (Zombies_Area_2D.ZIndex == GetNode<Crash_Area_2D>("Main/Crash_Area").Crash_Area.ZIndex && Zombies_Area_2D.GetParent().GetParent().GetParent().GetIndex() > GetNode<Crash_Area_2D>("Main/Crash_Area").Crash_Area.GetParent().GetParent().GetParent().GetIndex()))
                    {
                        GetNode<Crash_Area_2D>("Main/Crash_Area").Crash_Area = Zombies_Area_2D;
                    }
                }
