        ...
        if (!on_Shovel)
        {
            if (!has_change_N_H)
            {
                ...
                if (Dock_Area_2D != null)
                {
                    ...
                    {
                        if (Dock_Area_2D.N_H < N_OH && Dock_Area_2D.pH < 6f)
                        {
                        ...
                        {
                            Dock_Area_2D.Change_pH(0f, N_OH, 55.6f);
                        }
                    }
                }
                for (int i = 0; i < Water_Area_List.Count; i++)
                {
                    if (Water_Area_List[i].N_H < N_OH && Water_Area_List[i].pH < 6f)
                    {
                        Water_Area_List[i].N_H = 1E-7f * Water_Area_List[i].N_H2O;
                        Water_Area_List[i].N_OH = 1E-7f * Water_Area_List[i].N_H2O;
                        Water_Area_List[i].pH = 7;
                    }
                    else
                    {
                        Water_Area_List[i].Change_pH(0f, N_OH, 55.6f);
                    }
                }
            }
        }
