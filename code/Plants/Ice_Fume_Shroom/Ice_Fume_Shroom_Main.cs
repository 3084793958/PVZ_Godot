...
public class Ice_Fume_Shroom_Main : Normal_Plants
{
    //lock_protect
    ...
    public async void Bug_Doing()
    {
        ...
        for (int i = 0; i < 25; i++)
        {
            ...
            In_Game_Main.Plants_Bullets_Clone_Request(Bullets_Path, GetNode<Bullets_Way_Area>("Main/Bullets_Way").GlobalPosition);//炼丹炉
        }
    }
